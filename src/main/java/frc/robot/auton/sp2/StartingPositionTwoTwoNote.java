...
public class StartingPositionTwoTwoNote extends SequentialCommandGroup {
    ...
    public StartingPositionTwoTwoNote(RobotContainer container, Elevator elevator, Drawer drawer, SwerveDrivetrain drivetrain, Roller roller, SimpleShooter shooter, Neck neck, Mouth mouth){

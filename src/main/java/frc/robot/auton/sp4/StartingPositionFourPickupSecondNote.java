...
public class StartingPositionFourPickupSecondNote extends ParallelCommandGroup {
	...
	public static Trajectory createPickupSecondNoteTrajectory(RobotContainer container) {
		...
		Trajectory trajectory = TrajectoryGenerator.generateTrajectory(
			...
			new Pose2d(AutonConstants.STARTING_POSITION_4_X_VALUE-AutonConstants.STARTING_POSITION_4_X_VALUE, AutonConstants.STARTING_POSITION_4_Y_VALUE-AutonConstants.STARTING_POSITION_4_Y_VALUE, Rotation2d.fromDegrees(0)),
			// Pass through these waypoints
			List.of(),
			// End straight ahead of where we started, facing forward
			new Pose2d(AutonConstants.STARTING_POSITION_4_X_VALUE-AutonConstants.DISTANCE_FROM_STARTING_POSITION_4_TO_SECOND_PICKUP_X, AutonConstants.STARTING_POSITION_4_Y_VALUE-AutonConstants.DISTANCE_FROM_STARTING_POSITION_4_TO_SECOND_PICKUP_Y, Rotation2d.fromDegrees(-60)),

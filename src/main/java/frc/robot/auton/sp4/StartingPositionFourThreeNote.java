...
public class StartingPositionFourThreeNote extends SequentialCommandGroup {
    ...
    public StartingPositionFourThreeNote(RobotContainer container, Elevator elevator, SwerveDrivetrain drivetrain, Roller roller, Shooter shooter, Neck neck, Mouth mouth){

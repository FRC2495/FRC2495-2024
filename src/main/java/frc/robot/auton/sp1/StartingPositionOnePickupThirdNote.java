...
public class StartingPositionOnePickupThirdNote extends ParallelCommandGroup {
    ...
    public StartingPositionOnePickupThirdNote(RobotContainer container, SwerveDrivetrain drivetrain, Roller roller, ICamera camera){

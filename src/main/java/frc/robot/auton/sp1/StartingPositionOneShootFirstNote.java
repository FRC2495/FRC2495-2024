...
public class StartingPositionOneShootFirstNote extends ParallelCommandGroup {

    public StartingPositionOneShootFirstNote(RobotContainer container, SwerveDrivetrain drivetrain, ICamera camera){

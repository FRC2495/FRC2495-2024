...
public class StartingPositionThreePickupSecondNote extends ParallelCommandGroup {
    ...
    public Trajectory createPickupSecondNoteTrajectory(RobotContainer container) {
		...
		Trajectory trajectory = TrajectoryGenerator.generateTrajectory(
			...
			new Pose2d(AutonConstants.STARTING_POSITION_3_X_VALUE-AutonConstants.DISTANCE_FROM_STARTING_POSITION_3_X_VALUE_TO_SECOND_NOTE_PICKUP_X, AutonConstants.STARTING_POSITION_3_Y_VALUE-AutonConstants.DISTANCE_FROM_STARTING_POSITION_3_X_VALUE_TO_SECOND_NOTE_PICKUP_Y, Rotation2d.fromDegrees(60)),

...
public class AutonConstants {
	...
	public static final double DISTANCE_FROM_STARTING_POSITION_6_TO_BEFORE_MIDLINE_NOTE_PICKUP_Y = 1;//5; //4; //6;
	public static final double DISTANCE_FROM_BEFORE_MIDLINE_NOTE_PICKUP_TO_NOTE_PICKUP_X = 3.2;
	public static final double DISTANCE_FROM_BEFORE_MIDLINE_NOTE_PICKUP_TO_NOTE_PICKUP_Y = .8;
	public static final double DISTANCE_FROM_AREA_AFTER_MIDLINE_NOTE_PICKUP_TO_TOWARDS_SPEAKER_X = 2; //3.2;
	public static final double DISTANCE_FROM_AREA_AFTER_MIDLINE_NOTE_PICKUP_TO_TOWARDS_SPEAKER_Y = 1; //2.8;

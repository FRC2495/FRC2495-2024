...
public class AutonConstants {
	...
	public static final double DISTANCE_FROM_SECOND_NOTE_PICKUP_TO_SHOOT_SECOND_NOTE_X = 1.5; //2 //1.2 //2.58;
	...
	public static final double DISTANCE_FROM_STARTING_POSITION_3_TO_BEFORE_MIDLINE_NOTE_PICKUP_Y = 1;//5; //4; //6;
	public static final double DISTANCE_FROM_AFTER_MIDLINE_NOTE_PICKUP_TO_AREA_TOWARDS_SPEAKER_X = 3.2;
	public static final double DISTANCE_FROM_AFTER_MIDLINE_NOTE_PICKUP_TO_AREA_TOWARDS_SPEAKER_Y = 2.8;
	public static final double DISTANCE_FROM_BEFORE_MIDLINE_NOTE_PICKUP_TO_MIDLINE_NOTE_PICKUP_X = 4.2;
	public static final double DISTANCE_FROM_BEFORE_MIDLINE_NOTE_PICKUP_TO_MIDLINE_NOTE_PICKUP_Y = .8;

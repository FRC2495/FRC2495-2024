...
public class AutonConstants {
	...
	public static final double DISTANCE_FROM_BEFORE_MIDLINE_NOTE_PICKUP_TO_NOTE_PICKUP_X = 4.2;
	public static final double DISTANCE_FROM_BEFORE_MIDLINE_NOTE_PICKUP_TO_NOTE_PICKUP_Y = .8;
	public static final double DISTANCE_FROM_AREA_AFTER_MIDLINE_NOTE_PICKUP_TO_TOWARDS_SPEAKER_X = 3.2;
	public static final double DISTANCE_FROM_AREA_AFTER_MIDLINE_NOTE_PICKUP_TO_TOWARDS_SPEAKER_Y = 2.8;

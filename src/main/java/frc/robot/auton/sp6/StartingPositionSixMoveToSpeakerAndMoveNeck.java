...
public class StartingPositionSixMoveToSpeakerAndMoveNeck extends ParallelRaceGroup{
	
	public StartingPositionSixMoveToSpeakerAndMoveNeck(SwerveDrivetrain drivetrain, RobotContainer container, Roller roller, Neck neck, ICamera apriltag_camera) {
